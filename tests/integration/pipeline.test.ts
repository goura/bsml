...
describe('Full Pipeline Integration', () => {
  ...
  test('T4: MegaHoldings calculatedHeight is massively larger than AlphaVentures', () => {
    ...
    // Equity header row (BS_HEADER_HEIGHT) adds a flat constant to both nodes,
    // which slightly reduces the ratio for smaller nodes. Threshold adjusted accordingly.
    expect(megaH / alphaH).toBeGreaterThan(3.0);
  });
